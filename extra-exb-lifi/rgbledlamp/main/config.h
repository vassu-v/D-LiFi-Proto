...
#define IR_TX_RIGHT    D0  // Right direction  
#define IR_TX_BACK     D0  // Backward direction
#define IR_TX_LEFT     D7  // Left direction

#define IR_RX_PIN      D5  // IR receiver module (INPUT)

// RGB LED indicator (common cathode)
#define LED_RX_PIN     D1  // Green channel - blinks when receiving
#define LED_TX_PIN     D3  // Red channel - blinks when transmitting
#define LAMP_LIGHT_PIN D8  // Lamp LED - for LiFi transmission (OUTPUT)

// ==================== RGB LED CONFIGURATION ====================

// RGB LED is common cathode (GND connected to ground)
// Active HIGH to turn on
#define LED_RX_ON()   digitalWrite(LED_RX_PIN, HIGH)
#define LED_RX_OFF()  digitalWrite(LED_RX_PIN, LOW)
#define LED_TX_ON()   digitalWrite(LED_TX_PIN, HIGH)
#define LED_TX_OFF()  digitalWrite(LED_TX_PIN, LOW)
