...
void setup(){
  ...
  Serial.println("\n================================");
  Serial.println("  LiFi Mesh Lamp Node V3 (IR-INT)");
...
void loop(){
  ...
  // ===== TASK 5: Display current gradient status (optional debug) =====
  static unsigned long lastStatusPrint = 0;
  if(millis() - lastStatusPrint > 30000){  // Every 30 seconds
    Serial.println("--- Status ---");
    Serial.print("myHop: "); Serial.println(myHop);
    Serial.print("lastInitID: "); Serial.println(lastInitID.length() > 0 ? lastInitID : "None");
    Serial.println("--------------");
